...
from .mail import new_order, new_user_registered
...
from orders.models import ProductInfo, Shop, Order, ConfirmEmailToken, OrderItem, User
...
class ProductsViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    # ранее было два отдельных класса для просмотра всех продуктов и конкретного(APIView и RetrieveAPIView)
    # объединила в ModelViewSet(добавила только для чтения
    """
